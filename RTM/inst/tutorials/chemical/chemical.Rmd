...
To learn more about modelling of chemical reactions --- and specifically of irreversible elementary chemical reactions --- try to solve the *ozone* model available in the R-package RTM. To display this exercise, type in the R-console:
