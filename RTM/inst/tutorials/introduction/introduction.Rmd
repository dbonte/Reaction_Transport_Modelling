...
Soetaert and Herman, A practical guide to ecological modelling.
...
incorrect = "We recommend interaction with your classmates on the course topics - compare your model steps and model solutions with each other!",
correct = "We recommend interaction with your classmates on the course topics - compare your model steps and model solutions with each other!")
```
...
question("Which systems are we going to study in this course?", type = "learnr_checkbox",
 ...
 incorrect = "We will cover a lot of different systems, but we will stay close to the Earth's surface.",
 correct = "We will cover a lot of different systems, but we will stay close to the Earth's surface."
)
```
