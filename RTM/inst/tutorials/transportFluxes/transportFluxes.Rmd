...
question("Which of the following statements is true?", type = "learnr_checkbox",
 ...
 incorrect=sprintf("The transport flux $J$ is in $mol~m^{-2}s^{-1}$, the advection velocity $v$ is in $m~s^{-1}$, the concentration $C$ is in $mol~m^{-3}$."),
 correct=sprintf("The transport flux $J$ is in $mol~m^{-2}s^{-1}$, the advection velocity $v$ is in $m~s^{-1}$, the concentration $C$ is in $mol~m^{-3}$.")  
)
```
...
question("Which of the following statements is true?", type = "learnr_checkbox",
 ...
 answer(sprintf("$\\frac{\\partial C}{\\partial x}$ is the concentration gradient in the medium, in $mol~m^{-4}$"), correct=TRUE),
  ...
  incorrect=sprintf("The flux $J$ is in $mol~m^{-2}~s^{-1}$, the diffusion, dispersion or bioturbation mixing coefficient $D$ is in $m^2~s^{-1}$, the concentration $C$ is in $mol~m^{-3}$, and the concentration gradient $\\frac{\\partial C}{\\partial x}$ is in $mol~m^{-4}$."),
correct=sprintf("The flux $J$ is in $mol~m^{-2}~s^{-1}$, the diffusion, dispersion or bioturbation mixing coefficient $D$ is in $m^2~s^{-1}$, the concentration $C$ is in $mol~m^{-3}$, and the concentration gradient $\\frac{\\partial C}{\\partial x}$ is in $mol~m^{-4}$.")  
)
```
