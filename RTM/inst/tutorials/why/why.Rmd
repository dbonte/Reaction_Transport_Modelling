...
question("Why do we develop scientific models?", type = "learnr_checkbox",
  ...
  incorrect = "Modelling IS a lot of fun, but this is not our primary goal. We use models in addition to data gathering because they give a different perspective of reality. They increase our understanding, allow us to extrapolate, may guide our research, and may be used to generate hypotheses.",
  correct = "Modelling IS a lot of fun, but this is not our primary goal. We use models in addition to data gathering because they give a different perspective of reality. They increase our understanding, allow us to extrapolate, may guide our research, and may be used to generate hypotheses." 
  )
```
...
question("What is the focus of the models that we will develop in this course?", type = "learnr_checkbox",
 ...
 incorrect = "Although we can do all the things listed above with mechanistic models, in this course we restrict ourselves to exchanges of mass and energy and on biogeochemistry and ecology relating to the environment.",
 correct = "Although we can do all the things listed above with mechanistic models, in this course we restrict ourselves to exchanges of mass and energy and on biogeochemistry and ecology relating to the environment.")
```
