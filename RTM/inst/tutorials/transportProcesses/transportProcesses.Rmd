...
## General transport equation-III
...
question("Which of the following sentences is true?", type = "learnr_checkbox",
 ...
 answer(sprintf("J denotes the flux in x-direction, in mol $m^{-2}s^{-1}$"), correct = TRUE),
...
incorrect=sprintf("Each of the terms in the equation has a SI unit of mol $m^{-3}$ $s^{-1}$, as the SI unit of C is mol $m^{-3}$, and the SI unit of t is $s$ (second). The flux J in the second term on the right therefore has to have the unit of mol $m^{-2}$ $s^{-1}$, which is indeed the correct unit of flux"),
correct=sprintf("Each of the terms in the equation has a SI unit of mol $m^{-3}$ $s^{-1}$, as the SI unit of C is mol $m^{-3}$, and the SI unit of t is $s$ (second). The flux J in the second term on the right therefore has to have the unit of mol $m^{-2}$ $s^{-1}$, which is indeed the correct unit of flux")  
)
```
