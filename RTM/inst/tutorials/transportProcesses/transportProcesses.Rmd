...
incorrect="Mathematically, if $A$ is constant (i.e., it is *not* a function of $x$), it can be taken out of the derivative of the general equation. This yields the second - simplified - equation.",
correct="Mathematically, if $A$ is constant (i.e., it is *not* a function of $x$), it can be taken out of the derivative of the general equation. This yields the second - simplified - equation."  
)
```
