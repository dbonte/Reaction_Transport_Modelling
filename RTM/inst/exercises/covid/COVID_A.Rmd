...
But: as we have mentioned several times, models are just an abstraction of reality, and they cannot capture everything! This is perfectly represented by the following cartoon (from https://www.nytimes.com/2020/09/10/health/university-illinois-covid.html):

![Do not take this modelling too seriously.](10virus-illinois-xkcd-mobileMasterAt3x.png)

You can see how to make a model of a COVID pandemic in the video from the following link:
https://www.youtube.com/watch?v=4-gjEhk7wfU
