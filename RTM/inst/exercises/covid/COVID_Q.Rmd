...
vignette: >
  %\VignetteIndexEntry{The COVID19 pandemic: modeling exercise}
...
![Conceptual scheme of the simplest SIR model.](SIR.png){width=70%}
...
Use the template R markdown file *RTM_0D.Rmd* to implement this model\footnote{you can download this file from Rstudio: "File->new File->Rmarkdown..->from template->RTM_0D". Save this file under a different name, e.g., SIR.Rmd. Do not forget to change the heading of this file.}.
