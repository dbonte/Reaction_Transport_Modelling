...
* rEmigration, the herbivore emigration rate constant, 0 in case there is no emigration (the default)
* rInfect, the nematode infection rate constant, set to 0 in the absence of infection
...
We then solve the model for various conditions: first the default run, then a run with IRIS-dependent grazing, with nematode infection and finally two runs with emigration. We plot all in one figure. 
...
# plot all at once
plot(out, out2, out3, out4, out5, type = "l", lwd = 2, lty = 1)
