...
vignette: >
  %\VignetteIndexEntry{Creating conceptual models: modeling exercises}
...
Despite the substantial efforts in European countries, in 2020 and 2021, the Corona virus spread all over the continent and making casualties. 
...
* One of the challenges was the spread of the so-called “new variants” that are more infectious (e.g., the British, South-African, Indian variant). Adapt the conceptual scheme to include the “British variant”. Clarify assumptions that you make in this new conceptual model.

# Exercise 4.	Crops and weed.

A farmer wants to optimise his harvest of lettuce. He should decide whether to fertilize his land with phosphate once, before planting, or at regular occasions after the lettuce have been planted, and how much of the fertilizer to add.

The problem he has is that the field of lettuce is invaded by a weed that grows slower than the lettuce, but that has a much deeper root system. Whereas roots of lettuce penetrate 7 cm deep into the soil, the weed’s roots penetrate up to a depth of 14 cm.

Once the fertilizer is added to the soil, it percolates, via the rain, from the upper 7 cm to the deeper soil layer, at a rate of 0.5% per day.
