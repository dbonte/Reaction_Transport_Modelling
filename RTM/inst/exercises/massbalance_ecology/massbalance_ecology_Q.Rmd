...
* What state variables will be in your model? 
...
# Exercise 3. Population dynamics in Serengeti National Park

The following describes the carbon transfer through a (simple) food web of the short grassland savannah of the Serengeti National Park in Tanzania. 
Wildebeest are migrating in and out of the park. While passing through the park the Wildebeest themselves do not eat. However, thye are preyed upon by lions that remain within the park. Another important cause of death is rinder pest (a disease). 
...
* Determine the basic ingredients of the model
  ...
  -	What are the system and its boundaries? 
  -	What are the state variables? 

* Make a flow scheme of the ecosystem model
  - What are the transport and reaction processes?

* Translate the model scheme into a set of balance statements
...
Oysters feed by drawing water in over their gills through the beating of cilia. Suspended algae are trapped in the mucus of these gills, and from there are transported to the mouth, where they are ingested. However, a significant fraction of the algae that is filtered from the water column is rejected by the animal before it enters the gut; this “pseudofaeces” is expelled and deposits on the sediment floor. 
...
In addition to the pseudofaeces and faeces produced during oyster feeding, natural mortality of both oyster species also add to detritus in the sediment. Within the sediment, the detritus is mineralized to release nutrients. 

## Tasks

Make a nitrogen-based model that focusses on these interactions. 

* Determine the basic ingredients of the model and make a flow scheme of the ecosystem model
  - What are the state variables, and suitable units?
  - What are the processes? (and what are the units of the processes?)
