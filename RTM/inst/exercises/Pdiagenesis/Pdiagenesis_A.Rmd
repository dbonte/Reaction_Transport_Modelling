---
title: "Reactive transport in porous media: a simple model of phosphorus cycling in marine sediments"
...
plot(sol2, sol3, xyswap=TRUE, grid = Grid$x.mid, lty=1, lwd=2,
     which = c("Quotient"), xlim = c(0,0.3), col=c(2,3),
...
![Integrated budgets. Numbers to be added from the table above (or below).](Pdynamics.png){width=80%}
