...
The basic principles that we are going to expand upon here are explained in the Readers entitled "Local equilibrium chemistry in R — part III" and "Anoxia in the Scheldt estuary". It is important that you have fully understood the material covered in those Readers before you start reading the following text. 
...
```{r, message=FALSE}
AE <- aquaenv(S=35, t=20, pH=8.2, SumCO2=2e-3, SumH2SO4=c(0, 28e-3))
...
Frankignoulle, M., I.Bourge, R. Wollast, 1996. Atmospheric CO, fluxes in a highly polluted estuary (the Scheldt). Limnol. Oceanogr., 4 l(2), 1996, 365-369.
